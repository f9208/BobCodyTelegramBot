...
import ru.bobcody.updates.handlers.chathandlers.secondlayerhandler.utils.ElkExecutor;
...
@Slf4j
//@Component
@PropertySource(value = "classpath:src/test/oldRes/additional.properties", encoding = "UTF-8")
