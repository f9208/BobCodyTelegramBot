...
public class TextConstantHandler {
    /* fga */
    public static final String DEFAULT_ADVICE = "советую не обкакаться!";
    public static final String SERVICE_FGA_NOT_AVAILABLE = "че то сервис не алё. совет от бота - не еби, блять, другим (и себе) мозги!";
