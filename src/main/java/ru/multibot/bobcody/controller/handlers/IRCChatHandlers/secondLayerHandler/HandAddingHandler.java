...
import ru.multibot.bobcody.SQL.Servies.CapsQuoteStorageService;
import ru.multibot.bobcody.SQL.Servies.CapsQuoteStorageServiceImp;
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                for (Object entryObj : mapForHandAdd.entrySet()) {
                    ...
                    capsQuoteStorageServiceImp.handleAdd(singleEntry.getKey(), singleEntry.getValue());
