...
//        assertThat(textMessageMainHandler.handle(TELEGRAM_MESSAGE_3).getText()).
...
//        TELEGRAM_MESSAGE_3.setText(command);
//        Assertions.assertThat(textMessageMainHandler.handle(TELEGRAM_MESSAGE_3).getText()).isNull();
//    }
//
