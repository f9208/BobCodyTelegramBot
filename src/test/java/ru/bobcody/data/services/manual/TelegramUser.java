...
public class TelegramUser {
    ...
    public static final User ADMIN_TELEGRAM = new User();

    static {
        ADMIN_TELEGRAM.setId(445682905L);
        ADMIN_TELEGRAM.setFirstName("Jonny");
        ADMIN_TELEGRAM.setLastName("Oker");
        ADMIN_TELEGRAM.setUserName("Admin");
        ADMIN_TELEGRAM.setLanguageCode("ru");
    }
}
